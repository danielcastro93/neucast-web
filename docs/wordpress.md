...
Léelo junto con [arquitectura.md](arquitectura.md), que explica cómo está armado
el front.
...
```js
{
  resumen: "...",              // el párrafo bajo el título
  destacados: ["...", "..."],  // lo que la vende; el primero alimenta la meta descripción
